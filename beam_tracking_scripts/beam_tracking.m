...
for config_idx = 1:length(tx_antennas_configs)
    ...
    %% Save the Data
    beam_tracking_save_input = ['beam_tracking_input_bits_' num2str(bfm) '_' num2str(rotation) '_' num2str(length(tx_antennas)) 'x' num2str(length(tx_antennas)) '.mat'];
    save(beam_tracking_save_input, "input_bits", '-mat');
    ...
    %% Save the Data
    beam_tracking_t_hat = ['beam_tracking_t_hat_' num2str(bfm) '_' num2str(rotation) '_' num2str(length(tx_antennas)) 'x' num2str(length(tx_antennas)) '.mat'];
    save(beam_tracking_t_hat, "t_hat", '-mat');
