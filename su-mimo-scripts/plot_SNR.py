...
plt.ylim(2, 16)
plt.legend(fontsize=font_size-10, loc='upper center', bbox_to_anchor=(0.3, 0.43), ncol=1, framealpha=0.0, columnspacing=0.3, handlelength=0.7)
plt.tight_layout()

# Save and show the plot
plt.savefig('SNR_8x8_su-mimo.png', dpi=300, format='png')
plt.savefig('SNR_8x8_su-mimo.eps', dpi=300, format='eps')
plt.show()
