...
[tx_symbols_1, encoded_bits_1] = qpsk_modulation(input_bits_3); 
[tx_symbols_2, encoded_bits_2] = qpsk_modulation(input_bits_3);
...
rx_symbols =  X_k(nFFT/2 + 1 + scMin:nFFT/2 + scMax, 6);
[rx_bits, received_bits] = qpsk_demodulation(rx_symbols);
errors = sum(received_bits ~= input_bits_3.');
BER = errors / size(input_bits_3,1)
